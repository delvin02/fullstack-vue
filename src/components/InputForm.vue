    ...
    <div class="input-form">
        <form @submit="submitForm" class="ui form">
            ...
            <div class="field">
                <div class="ui checkbox">
                    <input :checked="termsAndConditions" @change="onInputChange" name="TERMS_AND_CONDITIONS"
                        type="checkbox" />
        ...
        <div class="ui segment">
            ...
            <ul>
                ...
                <li v-for="item in $store.state.formModule.items" :key="item.id" class="item">{{ item }}</li>
            </ul>
        </div>
    </div>
</template>
...
export default {
    ...
    created() {
        ...
        console.log(this.$store.state.formModule.fields);
    ...
    methods: {
        ...
        submitForm(evt) {
            ...
            const items = [
                ...
                this.$store.state.formModule.fields.newItem
            ];
